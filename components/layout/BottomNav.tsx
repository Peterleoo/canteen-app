...
export const BottomNav: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 flex justify-around items-center z-50 pt-2 pb-[env(safe-area-inset-bottom)] shadow-[0_-1px_10px_rgba(0,0,0,0.02)] min-h-[calc(56px+env(safe-area-inset-bottom))]">
            {navItems.map((item) => {
